        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1>Modificar pregunta con imagenes</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header"><strong>Añadir nuevas preguntas con imagenes</strong>
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="company"
                                                                       class=" form-control-label">Agrerar respuesta
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="submit" name="submit2" value="Modificar pregunta"

        ...
        <tr>
            ...
            <td style="padding-left: 10px">
                ...
                if (strpos($opt1, 'images/') != false) {
                    ?>
                    <img src="admin/<?php echo $opt1; ?>" height="150" width="150">
                    <?php
                } else {
                    echo $opt1;
                }
        ...
        <tr>
            ...
            <td style="padding-left: 10px">
                ...
                if (strpos($opt2, 'images/') != false) {
                    ?>
                    <img src="admin/<?php echo $opt2; ?>" height="150" width="150">
                    <?php
                } else {
                    echo $opt2;
                }
        ...
        <tr>
            ...
            <td style="padding-left: 10px">
                ...
                if (strpos($opt3, 'images/') != false) {
                    ?>
                    <img src="admin/<?php echo $opt3; ?>" height="150" width="150">
                    <?php
                } else {
                    echo $opt3;
                }
        ...
        <tr>
            ...
            <td style="padding-left: 10px">
                ...
                if (strpos($opt4, 'images/') != false) {
                    ?>
                    <img src="admin/<?php echo $opt4; ?>" height="150" width="150">
                    <?php
                } else {
                    echo $opt4;
                }
